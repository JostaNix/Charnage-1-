...
module.exports = {
    ...
    async execute(client, message, args, Embed) {
        ...
        if(vmuteRoles.some(role => user.roles.cache.has(role))) return message.channel.error(message, `Belirttiğin üye **ses kanallarında** daha önce susturulmuş! Bilgi için : \`${Prefix}mutebilgi <@Noâ/ID>\``, { timeout: 8000, react: true });
