...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if(!args[0]) {
            ...
            if(!user) return message.channel.error(message, `${mark ? mark : ``}  Doğru kullanım : \`${Prefix}cezapuan <@Noâ/ID> / (ekle / sil)\``, { timeout: 8000, reply: true, react: true });
