...
module.exports = {
    ...
    aliases: ['role'],
    category: 'Yetkili',
    usage: '[ver / al] [<@Noâ/ID> / <@Rol/ID> / <#Kanal/ID>] <Rol İsmi/ID>',
    ...
    async execute(client, message, args, Embed) {
        ...
        if(!args[0]) return message.channel.error(message, Embed.setDescription(`${mark ? mark : ``}  Doğru kullanım : \`${Prefix}rol [ver / al] [<@Noâ/ID> / <@Rol/ID> / <#Kanal/ID>] <Rol İsmi/ID>\``), { timeout: 10000, react: true });
        ...
        if(['ver'].some(arg => args[0].toLocaleLowerCase() == arg)) {
            ...
            if(!user && !publicRole && !channel) return message.channel.error(message, Embed.setDescription(`${mark} Doğru kullanım : \`${Prefix}rol ver [<@Noâ/ID> / <@Rol/ID> / <#Kanal/ID>] <Rol İsmi/ID>\``), { timeout: 10000, react: true });
            ...
            if(!args[1]) return message.channel.error(message, Embed.setDescription(`Bir üye, rol veya ses kanalı belirtmelisin!`), { timeout: 8000, react: true });
            if(!user && !publicRole && !channel) return message.channel.error(message, Embed.setDescription(`${mark} Doğru kullanım : \`${Prefix}rol al [<@Noâ/ID> / <@Rol/ID> / <#Kanal/ID>] <Rol İsmi/ID>\``), { timeout: 10000, react: true });
        ...
        } else return message.channel.error(message, Embed.setDescription(`${mark ? mark : ``}  Doğru kullanım : \`${Prefix}rol [ver / al] [<@Noâ/ID> / <@Rol/ID> / <#Kanal/ID>] <Rol İsmi/ID>\``), { timeout: 10000, react: true });
